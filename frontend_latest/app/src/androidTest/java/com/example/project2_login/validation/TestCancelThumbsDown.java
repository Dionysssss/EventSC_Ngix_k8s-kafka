...
public class TestCancelThumbsDown {
    ...
    /**
     * Test: Log in, navigate to MapViewActivity, click a marker, thumbs-down, and then cancel thumbs-down.
     */
    @Test
    public void testCancelThumbsDown() throws InterruptedException {
        ...
        // Step 6: Cancel the thumbs-down (click the thumbs-down button again)
        onView(withId(R.id.thumbs_down_button)).perform(click());

        // Step 7: Verify the thumbs-down count decrements to 0
