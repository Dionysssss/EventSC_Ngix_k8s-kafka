...
public class TestThumbsDownIncrement {
    ...
    /**
     * Test: Log in, navigate to MapViewActivity, click a marker, and verify thumbs-down increment.
     */
    @Test
    public void testThumbsDownIncrementsCount() throws InterruptedException {
        ...
        // Step 4: Verify thumbs-down functionality
        onView(withId(R.id.thumbs_down_button)).perform(click());

        // Step 5: Verify the thumbs-down count increments to 1
        onView(withId(R.id.thumbs_down_count)).check(matches(withText("1")));
    }
