...
public class ValidationController {
    ...
    public ResponseEntity<?> confirmEvent(@PathVariable int eventId, @RequestBody Map<String, Object> userIdPayload) {
        Integer userId = (Integer) userIdPayload.get("userId");
        try {
    ...
    public ResponseEntity<?> withdrawConfirmation(@PathVariable int eventId, @RequestBody Map<String, Object> userIdPayload) {
        Integer userId = (Integer) userIdPayload.get("userId");
        try {
    ...
    public ResponseEntity<?> reportEventAsFalse(@PathVariable int eventId, @RequestBody Map<String, Object> userIdPayload) {
        Integer userId = (Integer) userIdPayload.get("userId");
        try {
    ...
    public ResponseEntity<?> withdrawFalseReport(@PathVariable int eventId, @RequestBody Map<String, Object> userIdPayload) {
        Integer userId = (Integer) userIdPayload.get("userId");
        try {
