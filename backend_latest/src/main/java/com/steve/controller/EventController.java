...
public class EventController {
    ...
    public ResponseEntity<?> deleteEvent(@PathVariable int eventId, @RequestBody Map<String, Integer> requestBody) {
    ...
    // Update class
    @PutMapping("/{eventId}")
    public ResponseEntity<?> editEvent(@PathVariable int eventId, @RequestBody IOEvent ioEvent) {
